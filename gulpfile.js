...
gulp.task("webpack:dev", function(callback) {
  ...
  devConfig.entry.app.unshift('webpack-dev-server/client?http://0.0.0.0:' + webpackPort);
  devConfig.devtool = "sourcemap";
  devConfig.debug = true;
  devConfig.output.publicPath = "http://0.0.0.0:" + webpackPort + "/";
  devConfig.plugins = devConfig.plugins.concat(
    new webpack.HotModuleReplacementPlugin(),
    new webpack.NoErrorsPlugin(),
    new OpenBrowserPlugin({ url: 'http://0.0.0.0:' + webpackPort })
  );
  ...
  new WebpackDevServer(webpack(devConfig), {
    ...
    gutil.log("[webpack-dev-server]", "http://0.0.0.0:"+webpackPort);
  });
});
